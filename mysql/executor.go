...
type DDOExecutor interface {
	...
	CreateDatabase(context.Context, *Conn, *query.Database) (*Result, error)
	// AlterDatabase should handle a ALTER database statement.
	AlterDatabase(context.Context, *Conn, *query.Database) (*Result, error)
	// DropDatabase should handle a DROP database statement.
	DropDatabase(context.Context, *Conn, *query.Database) (*Result, error)
	// CreateTable should handle a CREATE table statement.
	CreateTable(context.Context, *Conn, *query.Schema) (*Result, error)
	// AlterTable should handle a ALTER table statement.
	AlterTable(context.Context, *Conn, *query.Schema) (*Result, error)
	// DropTable should handle a DROP table statement.
	DropTable(context.Context, *Conn, *query.Schema) (*Result, error)
	// RenameTable should handle a RENAME table statement.
	RenameTable(context.Context, *Conn, *query.Schema) (*Result, error)
	// TruncateTable should handle a TRUNCATE table statement.
	TruncateTable(context.Context, *Conn, *query.Schema) (*Result, error)
}
